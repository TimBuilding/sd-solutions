  ...
  return (
    <div className="flex flex-row items-center justify-between pt-4">
      ...
      <div className="flex flex-row gap-2">
        <div className="group h-8 w-8 justify-end rounded-full border border-[#999999] hover:border-[#1ce589]">
          <Button variant="ghost" className="hover:bg-transparent">
            {' '}
            <ThumbsUp className="-ml-2 -mt-3 h-3.5 w-3.5 text-[#999999] group-hover:text-[#1ce589] " />
          </Button>
        </div>
        <div className="group h-8 w-8 justify-end rounded-full border border-[#999999] hover:border-red-500">
          <Button variant="ghost" className="hover:bg-transparent">
            {' '}
            <ThumbsDown className="-ml-2 -mt-2 h-3.5 w-3.5 text-[#999999] group-hover:text-red-500" />
          </Button>
        </div>
        <div className="group h-8 w-8 justify-end rounded-full border border-[#999999] hover:border-[#393a4f]">
          <Button variant="ghost" className="hover:bg-transparent">
            {' '}
